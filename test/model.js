...
(function() {
  ...
  describe('AP.model.Model', function() {
    ...
    describe('relationship', function() {
      ...
      server = null;
      beforeEach(function() {
        var ModelClass, RelatedModelClass;
        server = sinon.fakeServer.create();
        RelatedModelClass = (function(superClass) {
          extend(RelatedModelClass, superClass);

          function RelatedModelClass() {
            return RelatedModelClass.__super__.constructor.apply(this, arguments);
          }
